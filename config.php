...
define("APP_ID", "249e76302a7d4347c159129a2dd57040");
...
define("META_AUTHOR", "Emleons tech");
define("META_DESCRIPTION", "llivery for indonessia bus simulator");
define("META_KEYWORDS", "tbg livery");
...
define("MAX_RECORD_COUNT", 2000); //Default Max Records to Retrieve  per Page
...
define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['nickname'] : null ));
