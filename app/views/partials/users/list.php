                                    ...
                                    <table class="table  text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-secret_key"> Secret Key</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-nickname"> <?php echo $data['nickname']; ?></td>
                                                    <td class="td-secret_key"> <?php echo $data['secret_key']; ?></td>
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this livery" href="<?php print_link("users/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete ?" data-display-style="modal">
