...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="grid" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title text-light">Pending Livery</h4>
                </div>
                <div class="col ">
            ...
            <div class="container-fluid">
                <div class="">
                    <div class="">
                        ...
                        <div  class=" animated  slideInUp page-content">
                                            ...
                                            <div class="card p-0 mb-3 animated slideInUp" style="border-radius: 10px 10px 10px 10px; background-color:#333;">
                                                <div >
                                                    <img src="<?php echo $data['livery']; ?>" class="card-img-top" alt="livery" style="object-fit: cover; border-radius: 10px 10px 0 0; background-color:#000;">
                                                        ...
                                                        <div class="pl-2 py-1 "><span class="badge badge-primary pl-2"><?php echo $data['bus_type']; ?></span><span class="badge badge-warning pl-2"><?php echo "Pending"; ?></span></div> 
                                                    </div>
                                                    <div class="">
                                                    <div class="px-3 py-2">
